...
import ImageUpload from '../InputComponent/ImageUpload.jsx';
import PdfUpload from '../InputComponent/PdfUpload.jsx';
import VideoUpload from '../InputComponent/VideoUpload.jsx';
...
export default function ChatFooter() {
    ...
    const { inputComponent, setInputComponent, inputFile, setInputFile, joinedUsers, userChat } = useContext(ChatContext);
    ...
    const handleMessageSubmit = () => {
        ...
        if ((message || "").trim().length === 0  && (!inputFile)) {
            ...
            <div className="flex items-center space-x-2 w-full">
                ...
                <form className='flex flex-1'>
                    ...
                    <button
                        ...
                        className={`text-sm py-1 px-3 rounded-e cursor-pointer bg-[#8080806e] ${(message || "").trim().length > 0 || inputFile ? 'text-white' : 'text-gray-500'
                            }`}
                    >
